...
public class Main {
    public static void main(String[] args) throws DiagnosticNotAllowedException {
        ...
        Mechanic mechanic2 = new Mechanic("Механик 2", "№ 2");

        Mechanic mechanic3 = new Mechanic("3", "3");
        Mechanic mechanic4 = new Mechanic("Механик 4", "Компания 4");
        mechanics.add(mechanic1);
        mechanics.add(mechanic2);
        mechanics.add(mechanic3);

        DriverB driverB1 = new DriverB("1 категории B", true, 2);
        Car carLada = new Car("Lada", "Granta", 1.7, driverB1, Car.BodyType.SEDAN, mechanic1);
        carLada.printInfo();
        ...
        Car carAudi = new Car("Audi", "A8 50 L TDI quattro", 1.5, driverB2, Car.BodyType.SEDAN, mechanic3);
        carAudi.printInfo();
